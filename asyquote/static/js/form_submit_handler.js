...
$(document).ready(function () {
  ...
  $('#create_client_form, #update_client_form, #delete_client_form').submit(
    function (event) {
      ...
      [
        ...
        function (instance, toast) {
          ...
          document.getElementById(
            'deleteForm',
          ).action = `/builder/clients/delete/${clientId}/`;
    ...
    buttons: [
      [
        ...
        function (instance, toast) {
          ...
          document.getElementById(
            'deleteProductForm',
          ).action = `/builder/products/delete/${productId}/`;
    ...
    buttons: [
      [
        ...
        function (instance, toast) {
          ...
          document.getElementById(
            'deleteCategoryForm',
          ).action = `/builder/products/category/delete/${categoryId}/`;
    ...
    buttons: [
      [
        ...
        function (instance, toast) {
          ...
          document.getElementById(
            'deleteSupplierForm',
          ).action = `/builder/products/supplier/delete/${supplierId}/`;
...
function openUpdateModal(clientId) {
  var myModal = new bootstrap.Modal(
    document.getElementById(`staticClientUpdate${clientId}`),
  );
  myModal.show();
}
...
function openUpdateModal2(projectId) {
  var myModal2 = new bootstrap.Modal(
    document.getElementById(`staticProjectUpdate${projectId}`),
  );
  myModal2.show();
}
