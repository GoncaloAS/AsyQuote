...
function attachProductModalListeners() {
  ...
  productModals.forEach(function (productModal) {
    productModal.addEventListener('click', function () {
      ...
      const productLinksUrl = productModal.getAttribute(
...
function updateEditor() {
  ...
  let updateSupplierDropdown = document.getElementById(
    'updateSupplierDropdown',
  );
  let createSupplierDropdown = document.getElementById(
    'createSupplierDropdown',
  );
  let updateCategoryDropdown = document.getElementById(
    'updateCategoryDropdown',
  );
  let createCategoryDropdown = document.getElementById(
  ...
  if (switchElement) {
    if (switchElement.checked) {
      ...
      Array.from(filteredProducts).forEach((container) => {
        let links = container.querySelectorAll(
          "a[data-bs-toggle='modal'][data-bs-target='#staticProductInfo']",
        );
        links.forEach((link) => {
    ...
    if (!switchElement.checked) {
      ...
      Array.from(filteredProducts).forEach((container) => {
        let links = container.querySelectorAll(
          "a[data-bs-toggle='modal'][data-bs-target^='#staticProductUpdate']",
        );
        links.forEach((link) => {
          const productId = link.getAttribute('data-product-id');
...
function handleSuppliersChange(productId) {
  ...
  const supplierLinkFields = document.getElementById(
    'supplierLinkFields' + productId,
  );
  ...
  let selectedOptions = document.querySelectorAll(
    '#id_suppliers' + productId + ' option:checked',
  );
