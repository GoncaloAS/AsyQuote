...
class SectionQuote(models.Model):
    ...
    section_count = models.DecimalField(max_digits=15, decimal_places=1, null=True, blank=True, default=1)
...
class ServicesQuote(models.Model):
    ...
    project_key = models.UUIDField(default=uuid.uuid4, editable=False)
    section_key = models.DecimalField(max_digits=15, decimal_places=1, null=True, blank=True)
    service_count = models.DecimalField(max_digits=15, decimal_places=1, null=True, blank=True, default=1)
...
class PricesQuote(models.Model):
    ...
    project_key = models.UUIDField(default=uuid.uuid4, editable=False)
    services_key = models.DecimalField(max_digits=15, decimal_places=1, null=True, blank=True)
    prices_count = models.DecimalField(max_digits=15, decimal_places=1, null=True, blank=True, default=1)

    def save(self, *args, **kwargs):
        if self.cost is not None or self.charged is not None:
