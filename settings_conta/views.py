# views.py
from allauth.account.views import AddEmailForm, ConfirmEmailView, EmailView, PasswordResetFromKeyView
...
def definicoes_view(request):
    ...
    marketing_preferences_form = MarketingPreferencesForm(
        initial={
            ...
            if password_change_form.is_valid():
                ...
                if password_change_form.errors:
                    for errors in password_change_form.errors.values():
                        ...
                        break
                return JsonResponse({"error": True, "message": errors_message})
